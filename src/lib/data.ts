...
export const works: Work[] = [
  ...
  },
  {
    ...
    description: 'I crafted a visually engaging screenplay with minimal dialogue, rich character depth, and a subtle yet powerful emotional arc. This script is ideal for indie filmmakers seeking a simple yet impactful story that resonates with audiences.This is a 6-page excerpt. The full script is available upon request.The dialogues in this script are written in Hindi.',
